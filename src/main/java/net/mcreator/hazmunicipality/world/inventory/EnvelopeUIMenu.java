...
public class EnvelopeUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public EnvelopeUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		...
		this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 7, 79) {
		}));
		this.customSlots.put(2, this.addSlot(new SlotItemHandler(internal, 2, 25, 79) {
		}));
		this.customSlots.put(3, this.addSlot(new SlotItemHandler(internal, 3, 43, 79) {
		}));
		...
		this.customSlots.put(7, this.addSlot(new SlotItemHandler(internal, 7, 115, 79) {
		}));
		this.customSlots.put(8, this.addSlot(new SlotItemHandler(internal, 8, 133, 79) {
		}));
